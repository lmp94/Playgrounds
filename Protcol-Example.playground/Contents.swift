...
// Protocol Tutorial
// Main Assets:
//    - objects can conform to multiple protocols.
//    - code beomce modular (protocols as building blocks of functionality i.e.
//                           adding new functionality by conforming to protocol !=
//                           instantiating a new object_
